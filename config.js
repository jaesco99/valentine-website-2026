...
const CONFIG = {
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/dtms74ga0/video/upload/v1769952508/A_AP_ROCKY_-_STAY_HERE_VISUALIZER_a11bv3.mp3", // Music streaming URL
        startText: "🎵 Suéltela DJ",        // Button text to start music
        stopText: "🔇 Párela DJ",         // Button text to stop music
